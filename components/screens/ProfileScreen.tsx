    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col gap-2 mt-4">
            <button
              onClick={onLoad}
              className="w-full px-4 py-2 font-semibold text-sm rounded-lg transition-colors duration-300 focus:outline-none focus:ring-2 bg-yellow-500 text-slate-900 hover:bg-yellow-400 focus:ring-yellow-300"
            >
              Load Game
            </button>
            <button
...
const ProfileScreen: React.FC<ProfileScreenProps> = ({ profiles, onLoadProfile, onStartNewGame, onDeleteProfile }) => {
  ...
  return (
    <div className="animate-fadeIn w-full max-w-2xl mx-auto">
      <h2 className="text-2xl md:text-3xl font-bold text-center mb-6 text-slate-300">
