...
export const ITEM_TEMPLATES: Record<GearSlot, ItemTemplate[]> = {
    Weapon: [
        ...
        { name: 'Dagger', slot: 'Weapon', icon: '🔪', possibleStats: ['dex', 'critRate'] },
        { name: 'Staff', slot: 'Weapon', icon: '🪄', possibleStats: ['int', 'maxHp'] },
    ],
    Helmet: [
        { name: 'Iron Helm', slot: 'Helmet', icon: '🪖', possibleStats: ['defense', 'maxHp'] },
        { name: 'Leather Cap', slot: 'Helmet', icon: '🧢', possibleStats: ['dex', 'defense'] },
    ],
    Armor: [
    ...
    Boots: [
        ...
        { name: 'Leather Boots', slot: 'Boots', icon: '👞', possibleStats: ['dex', 'critRate'] },
    ],
    Gloves: [
